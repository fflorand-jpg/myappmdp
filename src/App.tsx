...
export default function App() {
  ...
  const handleDeleteCategory = async (catId: string) => {
    setConfirmModal({
      ...
      message: "Êtes-vous sûr de vouloir supprimer cette catégorie ? Les secrets associés seront transférés vers la catégorie 'Autre'.",
      ...
      onConfirm: async () => {
        ...
        if (count > 0) {
          ...
          try {
            ...
            console.warn("Erreur lors du transfert de secrets après suppression de la catégorie:", err);
          }
        }
  ...
  const handleExportBackup = () => {
    ...
    downloadAnchor.setAttribute('download', `mdp_chiffre_backup_${new Date().toISOString().slice(0, 10)}.json`);
          ...
          <div className="bg-white/95 backdrop-blur-md border border-white/20 p-8 rounded-3xl w-full max-w-md shadow-2xl space-y-6 transform hover:scale-[1.01] transition-all duration-300">
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-neutral-500 max-w-sm mx-auto leading-relaxed">
                Configurez votre clé d'accès locale maîtresse (au moins 4 caractères ou chiffres). Vos secrets sont cryptés au sein même de votre navigateur et ne quittent jamais votre terminal.
              </p>
            </div>
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 mt-2 ml-0.5">
                  {autoLockMinutes > 0 ? (
                    ...
                    "Secrets chiffrés en mémoire locale par clé AES-GCM-256"
                  )}
                </p>
              </div>
                  ...
                  <div key={cat.id} className="flex items-center justify-between p-2 rounded-lg border border-neutral-150 bg-neutral-50 hover:bg-neutral-100/50">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-[10px] text-neutral-400 font-mono">{count} secret(s)</div>
                      </div>
                    </div>
          ...
          <div className="bg-white border border-neutral-200 rounded-xl w-full max-w-md shadow-xl p-6">
            ...
            {recoveryStep === 'code' ? (
              <form onSubmit={handleVerifyRecoveryCode} className="space-y-4">
                <p className="text-xs text-neutral-500 leading-relaxed">
                  Veuillez entrer votre code de récupération pour réinitialiser le mot de passe maître de votre coffre-fort sans perdre vos secrets locaux.
                </p>
              ...
              <div className="space-y-1.5 flex-1 overflow-y-auto pr-1">
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-xs">Tous les secrets</span>
                  </div>
